...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 49: (a, b, c) => {
      "use strict";
      let d;
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = ["/login", "/api/notify", "/api/subscribe", "/manifest.json", "/sw.js", "/icon-192.png", "/icon-512.png"];
      function bu(a10) {
        let { pathname: b2 } = a10.nextUrl;
        return bt.some((a11) => b2.startsWith(a11)) ? S.next() : a10.cookies.get("cws_session")?.value !== process.env.APP_PASSWORD ? S.redirect(new URL("/login", a10.url)) : S.next();
      }
